...
De applicatie heeft een ingebouwd systeem om automatisch de gebruikte libraries te installeren waardoor de gebruiker niet noodzakelijk de requirements.txt moet downloaden. Uit voorzorg zal de requirements.txt nog steeds aanwezig zijn op de github!
